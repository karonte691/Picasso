...
namespace Picasso::Engine::Render::Core::Drivers
{
    ...
    public:
        ...
        bool BeginFrame(std::shared_ptr<RAPIData> apiData, float deltaTime, std::shared_ptr<PPlatformState> pState) override;
        bool EndFrame(std::shared_ptr<RAPIData> apiData, float deltaTime, std::shared_ptr<PPlatformState> pState) override;
